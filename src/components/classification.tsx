    ...
    <>
      <div
        ...
        <div className="grid grid-cols-2 gap-4 ">
          <button
            className="flex items-center justify-center py-4 text-xl transition duration-300 ease-in-out bg-neutral-200 cursor-pointer px-14 rounded-xl text-neutral-950 hover:bg-green-500"
            value={"true"}
            onClick={AnswerForm}>
            Yes
          </button>
          <button
            className="flex items-center justify-center py-4 text-xl transition duration-300 ease-in-out bg-neutral-200 cursor-pointer px-14 rounded-xl text-neutral-950 hover:bg-red-500 hover:text-neutral-50"
            value={"false"}
            onClick={AnswerForm}>
            No
          </button>
